...
module.exports = function(templateDirectories,outputFile,opts,done) {
	...
	async.waterfall([
		...
		function(callback) {
			...
			fs.appendFileSync(outputFile,"    	merge:pug_merge,\r\n")
			fs.appendFileSync(outputFile,"    	classes:pug_classes,\r\n")
			fs.appendFileSync(outputFile,"    	style:pug_style,\r\n")
			fs.appendFileSync(outputFile,"    	attr:pug_attr,\r\n")
			fs.appendFileSync(outputFile,"    	attrs:pug_attrs,\r\n")
			fs.appendFileSync(outputFile,"    	escape:pug_escape,\r\n")
			fs.appendFileSync(outputFile,"    	rethrow:pug_rethrow\r\n")
			fs.appendFileSync(outputFile,"    }\r\n")
			fs.appendFileSync(outputFile,"\r\n")
